...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AemetOpenData.Model401 = factory(root.AemetOpenData.ApiClient);
  }
  ...
  /**
   * The Model401 model module.
   * @module model/Model401
   * @version 2.0
   */

  /**
   * Constructs a new <code>Model401</code>.
   * @alias module:model/Model401
   * @class
  ...
  /**
   * Constructs a <code>Model401</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Model401} obj Optional instance to populate.
   * @return {module:model/Model401} The populated <code>Model401</code> instance.
   */
   ...
   */
  exports.prototype['descripcion'] = 'Unauthorized';
  /**
