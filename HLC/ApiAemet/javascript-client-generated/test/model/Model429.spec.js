...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AemetOpenData.Model429();
  });
  ...
  describe('Model429', function() {
    it('should create an instance of Model429', function() {
      // uncomment below and update the code to test Model429
      //var instance = new AemetOpenData.Model429();
      //expect(instance).to.be.a(AemetOpenData.Model429);
    });
