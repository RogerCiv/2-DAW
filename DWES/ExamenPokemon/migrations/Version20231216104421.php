 ...
 */
final class Version20231216104421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, tipo_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, number INT NOT NULL, img VARCHAR(255) NOT NULL, INDEX IDX_62DC90F3A9276E6C (tipo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
