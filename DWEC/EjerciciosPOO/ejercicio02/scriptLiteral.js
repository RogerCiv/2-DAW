...
import { ComidaLiteral , DietaLiteral } from './assets/modules.js';
...
let newFood ;
const miDieta =  Object.create(DietaLiteral);
...
function handlerInsertFood(e) {
  ...
  if (isNaN(inputCalorias.value) || inputCalorias.value < 0) {
   ...
   newFood = Object.create(ComidaLiteral);

  newFood._nombre = inputAlimento.value;
  newFood._calorias = parseFloat(inputCalorias.value);
